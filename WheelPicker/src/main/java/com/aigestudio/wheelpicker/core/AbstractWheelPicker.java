...
public abstract class AbstractWheelPicker extends View implements IWheelPicker {
	...
	protected void obtainAttrs(AttributeSet attrs) {
		...
		if (null != attrs) {
			TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.AbstractWheelPicker);
			...
			itemSpace = a.getDimensionPixelSize(R.styleable.AbstractWheelPicker_wheel_item_space, defItemSpace);

			textSize = a.getDimensionPixelSize(R.styleable.AbstractWheelPicker_wheel_text_size, defTextSize);
			textColor = a.getColor(R.styleable.AbstractWheelPicker_wheel_text_color, defTextColor);

			curTextColor = a.getColor(R.styleable.AbstractWheelPicker_wheel_text_color_current, defCurTextColor);
	...
	protected void onSizeChanged(int w, int h, int oldW, int oldH) {
		...
		mDrawBound.set(getPaddingLeft(), getPaddingTop(), w - getPaddingRight(), h - getPaddingBottom());
